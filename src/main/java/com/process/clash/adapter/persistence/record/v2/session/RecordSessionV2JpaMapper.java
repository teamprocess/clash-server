...
public class RecordSessionV2JpaMapper {
    ...
    public RecordSessionV2 toDomain(RecordActiveSessionV2JpaEntity entity) {
        ...
        return new RecordSessionV2(
            ...
            entity.getUser().getId(),
            sessionType,
            taskSession == null || taskSession.getSubject() == null ? null : taskSession.getSubject().getId(),
            taskSession == null || taskSession.getSubject() == null ? null : taskSession.getSubject().getName(),
