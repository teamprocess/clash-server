...
public class RivalPersistenceAdapter implements RivalRepositoryPort {
    ...
    public int countActiveByUserId(Long userId) {
        ...
        return rivalJpaRepository.countActiveByUserId(userId);
    }
    ...
    @Override
    public List<Map<String, Object>> countAcceptedByUserIdsGrouped(List<Long> userIds) {

        return rivalJpaRepository.countAcceptedByUserIdsGrouped(userIds);
    }
    ...
    @Override
    public List<Rival> findAllRivalsByUserId(Long userId) {

        return rivalJpaRepository.findAllRivalsByUserId(userId)
                .stream()
                .map(rivalJpaMapper::toDomain)
                .toList();
    }
