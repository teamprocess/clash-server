...
public interface UserNoticeRepositoryPort {
    ...
    void deleteApplyRivalNoticeByRivalIds(List<Long> rivalIds);
    void deactivateApplyRivalNoticeByRivalId(Long rivalId);
    ...
    void deactivateApplyBattleNoticeByBattleId(Long battleId);
    int deleteByIdAndReceiverId(Long id, Long receiverId);
