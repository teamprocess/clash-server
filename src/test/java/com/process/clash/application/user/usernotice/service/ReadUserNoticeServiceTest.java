...
class ReadUserNoticeServiceTest {
    ...
    void execute_savesWhenNoticeIsUnread() {
        ...
        Long noticeId = 10L;
        UserNotice unreadNotice = new UserNotice(noticeId, Instant.now(), Instant.now(), NoticeCategory.APPLY_RIVAL, false, 2L, "senderA", 1L, "receiverA");
    ...
    void execute_skipsSaveWhenNoticeIsAlreadyRead() {
        Actor actor = new Actor(1L);
        Long noticeId = 10L;
        UserNotice readNotice = new UserNotice(noticeId, Instant.now(), Instant.now(), NoticeCategory.APPLY_RIVAL, true, 2L, "senderA", 1L, "receiverA");
